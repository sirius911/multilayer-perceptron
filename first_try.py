...
net.add(FCLayer(nb_input, 35))
net.add(ActivationLayer(relu, relu_prime))
net.add(FCLayer(35, 15))
net.add(ActivationLayer(relu, relu_prime))
net.add(FCLayer(15, 2))
net.add(ActivationLayer(softmax, softmax_prime))

net.use(mse, mse_prime)
print("training ...")
err, accuracy = net.fit(x_train, y_train, epochs=50, learning_rate=0.1)
print("ok")
...
print(f"f1_score = {f1_score_(category_to_bool(y_test), category_to_bool(out)):0.2f}")
print(category_to_bool(out))